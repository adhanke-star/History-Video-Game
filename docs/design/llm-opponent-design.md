...
> Gates (§8): GATE OK · node --check · probe-llm-commander ×2 0 pe · adjacents probe-ai/attacker-parity/presets/field + bullrun/fredericksburg spots (byte-identity) · auto-resolve 10/10 + campaign-link · diff-check · read-only Opus refute panel · commit/push · full docs trail. Then STOP at the D171 boundary with the slice-2 prompt. Queue after this milestone: E59 → Priority-1 Soldier's Story. M8/Q5/Q6 locked; Phase H parked; Phase D deferred. Helper routing D145/D223: readers Sonnet low-medium, panel lenses Opus high, never Fable on a helper.
