...
- **US:** Duncan's 3rd Brigade only, ~700 effectives total (single-specialist-source figure consistent with ABT's 2,000 combined — Inferred). The 4th USCT went in with 361 (11 officers + 350 enlisted, Fleetwood's first-person figure); the 6th USCT's ~339 is the arithmetic remainder (Inferred). Modeled bound: phase-1 US total 630-770. No US artillery accompanied the assault — the US fields 0 guns.
...
- phase-1 US total 630-770 with 0 US guns; phase-1 CS total 1,700-2,100 with exactly 8 CS guns; phase-2 US total 1,900-2,400; phase-2 CS total 600-1,100; every unit note carrying `Verified identity; Inferred strength` or `Verified withdrawal order; Inferred residual strength` (phase-2 CS);
