...
## 12. D383 Spec-Time Addendum (2026-07-12 research workflow: 6 Sonnet gather → 6 Opus default-refute → 1 Opus critic; Fable adjudication)

The D383 spec (`docs/design/fort-donelson-battle-build-spec.md`) was written from this packet plus a fresh 13-agent research pass. Three corrections to THIS packet's text, recorded here without rewriting the history above:

1. **The strength misreading (section 3/9 above):** the ABT infobox's **40,702 is the COMBINED two-side "Forces Engaged" total**, not a Union total — the page's own raw data attributes split it US **24,531** / CS **16,171** (24,531 + 16,171 = 40,702), matching Wikipedia's infobox. The "US 24,531 engaged = cite-pending" flag above is therefore resolved the OTHER way: 24,531 IS the ABT Union engaged figure (two-source Verified), and "US 40,702 total" was a misreading. The spec anchors US ~24,531 / CS ~16,171 engaged.
2. **Road-name disambiguation (sections 2/5 above):** the Feb 15 breakout opened the **Forge Road and a stretch of Wynn's Ferry Road** (NPS + Wikipedia). The **road to Charlotte** is associated with Forrest's separate post-surrender ride out on Feb 16 through the flooded Lick Creek backwater. The packet's "Charlotte Road (the escape route Forrest used)" conflated the two; the spec keeps the breakout objective (Forge/Wynn's Ferry corridor) distinct from Forrest's escape teaching.
3. **The phase-weight design error (section 2 above):** the packet's `[1, 3, 1]` (decisive = the breakout) contradicts D92 accurate-inputs law once the sourced phase leans are written down — CS holds (Feb 13 probes repulsed), CS seizes (the breakout opened the roads), US seizes (Smith carried the vacated works): under `[1, 3, 1]` the AI-vs-AI aggregate would lean Confederate, against the sourced Union victory. The spec ships `[1, 1, 3]` with Phase 3 decisive and preserves the "won the ground and threw it away" teaching on the Phase 3 transition card.

New Verified anchors from the pass (each 2+ independent sources; full register in the spec): the Feb 13 repulses (McClernand at Redan No. 2 / Maney's Battery under Heiman, ~200 casualties, Col. Morrison wounded; Smith's probe on Buckner's rifle pits with Hanson's 2nd Kentucky); the Feb 15 dawn breakout (Pillow's wing + Bushrod Johnson, Buckner supporting, Forrest flanking; two of McClernand's three front-line brigades broken; Forge Road + Wynn's Ferry stretch cleared by early afternoon; Oglesby/McArthur hit hardest; Lew Wallace's blocking ridge astride Wynn's Ferry Road); the recall (Pillow initiated over Buckner's objection, Floyd ratified); Smith's PM assault (Lauman's brigade, 2nd Iowa under Col. Tuttle leading, Cook feinting, the vacated right taken from the lone 30th Tennessee); the Dover Hotel devolution council (~1:30 a.m., Floyd's fear of federal arrest, Floyd→Pillow→Buckner); Grant's Feb 15 absence downriver with the wounded Foote and his return; Grant's exact reply text; the Feb 14 naval repulse detail (4 ironclads + Tyler/Conestoga, St. Louis 59 hits, both flag-steering losses, ~90 minutes, ~54 US naval casualties vs zero significant battery loss); Foote styled Flag Officer in every source; Bushrod Johnson Brig. Gen. from Jan 24, 1862 with brief nominal command Feb 9; no USCT existed Feb 1862 (Militia Act July 17, 1862).

Standing DISPUTES the spec ships as teaching, never counts: Floyd's escape headcount (unquantified / 3,000 / ~2,000-combined); Forrest's ride-out (≈700 cavalry vs 1,500 incl. infantry); surrendered total (≈11,500-15,000; 12,392 m&c the citation-grade single figure); Grant's MG-of-Volunteers exact date (Feb 16 vs 17 — the spec's rank lock avoids pinning it); water-battery totals (11 vs 12 guns; carronades vs howitzers in the upper battery); Fort Henry's bombardment duration. Brigade-grain OOB identities on both sides remain single-source (the two Wikipedia OOB pages) and ship `Inferred`.