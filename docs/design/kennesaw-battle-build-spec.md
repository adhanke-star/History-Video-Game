...
| NPS, Confederate Order of Battle (`https://www.nps.gov/kemo/learn/historyculture/confederate-order-of-battle.htm`) | Johnston, Hardee, Cheatham, Maney, Vaughan (rendered "Vaughn" on this page), Cleburne, Walker, French, Loring, and artillery organization | Verified for campaign OOB and principal defending formations; not a strength table. VMI Archives controls Vaughan's identity/spelling |
| VMI Archives Historical Rosters, Alfred Jefferson Vaughan (`https://archivesweb.vmi.edu/record.php?ID=443`) | Full name, Vaughan surname, VMI class, Confederate brigadier-general service | Verified identity/spelling anchor; use Vaughan in player-facing text while retaining the stable runtime id `cs_vaughn` |
...
- **Alfred J. Vaughan - Brigadier General, CSA.** Vaughan's Tennessee Brigade is in Cheatham's Division in the NPS Confederate OOB and is a required identity/rank guard. VMI Archives identifies Alfred Jefferson Vaughan; the NPS OOB's "Vaughn" rendering is a source variant, not the player-facing spelling. Preserve the stable runtime id `cs_vaughn`.
...
- Runtime probe must verify rank traps: Sherman = Maj. Gen.; Johnston = Gen.; Thomas, Schofield, McPherson = Maj. Gen.; Hardee = Lt. Gen.; Cheatham and Cleburne = Maj. Gen.; Maney and Vaughan = Brig. Gen.; Harker = Brig. Gen.; McCook and Mitchell = Col.; Hood is not army commander. It must also preserve `cs_vaughn` as the stable id while rejecting "Vaughn" on player-facing fields.
