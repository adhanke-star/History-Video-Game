...
| **R-6 — Negative-badge sweep + dev-traits** | Negatives across all 9 battles (provenance-tagged); wire `reputation` evolution into displayed OVR. | Legendary-roster balance review (≥90 club not >60% CS); reputation level-up reflected in OVR. |
