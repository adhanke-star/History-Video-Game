...
Read the first ⚡ amendment in [`HANDOFF.md`](HANDOFF.md) for the complete D512 law, owner locks, future Slice-1 contract, ARC 7 blocker, and exact next committed lane take. Do not derive current work from older wake-up or `NEXT` prose.
