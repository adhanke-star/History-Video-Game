...
- **Last-touched commit:** D362 (Gaines' Mill playable slice + Fable transfer) · D363 (New
  ...
  runtime movement; clean CONTRACT release — Claude Code / Claude Fable, this commit).
- **History:** lane opened by Claude Code 2026-07-10 after Aaron's popup Q&A (D359) fixed scope,
  ...
  2026-07-13 in this ledger-only commit at the clean D390 boundary `d46f1c7` (worktree clean,
  HEAD == origin/main verified before the take), scoped to the playable Spotsylvania runtime
  from the committed D390 contract only — spec §11 atomic integration, both negative binds with
  md5-identical restores, the 8-seed DEFENDER-HOLDS battery under the CASUALTY-DIRECTION-NEUTRAL
  law with an honest A/B log if any input moves, the §14 serialized runtime gate with full
  artifact readback, docs sync, and a clean release; no Wilderness, Cold Harbor, Petersburg,
  Crater, Overland multi-phase campaign, or war-career work in this session.
