...
- **State:** CONTRACT/unowned. D393's playable Wilderness remains the runtime boundary at **23 scenarios / schema 53 / Army Register 1434 / coverage 23 / suite 128 / sweep 23**; D394 verified all 128 commands, 127/127 expected JSONs, schema 53/53, and sweep 23×8=184 with failures 0. No runtime/data/generated-game/simulation input moved in D394. **Authoritative next boundary is decision-only: name the Petersburg trench treatment required by D382 item 3.5 or explicitly waive it and advance to the war-career loop; independently resolve whether packet-High Cold Harbor enters despite its absence from D382. Do not take DRIVE before Aaron resolves those choices.**
