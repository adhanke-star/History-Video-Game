...
### LANE-003 · battle-ladder — **VERIFY** (ChatGPT/Codex 5.6 Sol Ultra; D397 129-command release battery)

- **Owning tool:** ChatGPT/Codex (5.6 Sol Ultra), retaining VERIFY after recovering Claude Code / Fable's interrupted D397 runtime from the exact journals and replaying it over clean `origin/main` in `/private/tmp/codex-vg-recovery-019f62fe`. The final candidate, all focused/adjacent gates, every artifact, and both declared binds were independently re-proved without changing the D396 contract. The sole remaining scope is the complete serialized 129-command release battery and artifact audit; no other provider may edit this lane and nothing else may run beside the battery. The canonical Desktop checkout remains largely `compressed,dataless` and must not be overwritten or pulled across.
...
-->
- **State:** VERIFY — **D397 playable Petersburg is focused-gate green at 24 scenarios / schema 54 / Army Register 1512 / coverage 24 / suite 129 / sweep 24.** Single phase June 15-18; US attacker / CS defender; fog off; menu rank 69; 26 ids; US 55,540 / CS 27,460; opening 14,880 / 4,620; guns 28/38. Honest A/B finishes at city 8/8 and US-higher-loss 7/8 with no output lever. Final hashes: data `5534c67015ca643ca343a80d586ca263`; focused probe `9025eb752d6b264b0168377304e4d63a`; T1 `6281fba361ee39224e9d08b2d147d736`; T10 `9090a9be3e7234fc11a5de41bbdbfdf2`; HTML `e669982913feb54032253bf19bcd2b8b`; frozen base `c9db83fa99230ffb95bdfdfe059f3fb9`. The complete `npm run vet:noreg` 129-command battery is the sole resume action: run it alone in the safe clone, audit every fresh JSON/image/schema artifact and the 24×8 sweep, root-fix and exact-label resume any red, then release to CONTRACT/unowned. Do not start the war-career loop or another queue item before release.**
...
- **Resume pointer (authoritative, D397 VERIFY):** **Run the complete 129-command `npm run vet:noreg` release battery serialized and alone from `/private/tmp/codex-vg-recovery-019f62fe`. No helper, workflow, second browser, simultaneous edit, or other CPU-heavy task may run.** First confirm clean committed D397 `HEAD == origin/main`, `CODEX_SANDBOX != seatbelt`, suite list exactly 129, and no orphan server/Chrome. Read every fresh suite JSON for `ok:true`, zero failed steps/pageerrors/realErrors; verify schema HTML has 54 data rows; verify sweep 24×8=192 with `failures:[]`; verify Army Register 1512; decode every fresh PNG/JPEG and every JSON-referenced image. Root-fix any real red without weakening a tooth, focused-rerun it, then resume from its exact manifest label. Retain the D397 locks: city 8/8, US-higher-loss 7/8; scenarios/schema/register/coverage/suite 24/54/1512/24/129; data `5534c67015ca643ca343a80d586ca263`; focused probe `9025eb752d6b264b0168377304e4d63a`; T1 `6281fba361ee39224e9d08b2d147d736`; T10 `9090a9be3e7234fc11a5de41bbdbfdf2`; HTML `e669982913feb54032253bf19bcd2b8b`; frozen base `c9db83fa99230ffb95bdfdfe059f3fb9`. After a clean battery and complete artifact audit, record D398, rerun all twelve lane-grepping plan probes after the ledger edit, commit/push the release checkpoint, return LANE-003 to CONTRACT/unowned, and point next to the D382 item-4 war-career loop. Cold Harbor remains DEFERRED (D395, explicit-reorder-only). The canonical Desktop checkout remains largely `compressed,dataless`; never overwrite it or pull across it. No simultaneous edits by any provider; release batteries run alone.
