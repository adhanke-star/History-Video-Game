...
const SETUP = `(() => {
  ...
  try {
    ...
    check('ARMY REGISTER PIN: 15 Elkhorn side-unit ids produce exact cmd/nco/pvt trios and current total 1326', function() {
      ...
      if (reg.people.length !== 1326) throw new Error('Army Register total is ' + reg.people.length + ', expected 1326');
