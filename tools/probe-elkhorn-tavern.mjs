...
const SETUP = `(() => {
  ...
  try {
    ...
    check('ARMY REGISTER PIN: 16 Elkhorn side-unit ids produce exact cmd/nco/pvt trios and current total 1671', function() {
