...
const SETUP = `(() => {
  ...
  try {
    ...
    check('ARMY REGISTER PIN: 15 Elkhorn side-unit ids produce exact cmd/nco/pvt trios and current total 1380', function() {
      ...
      if (reg.people.length !== 1380) throw new Error('Army Register total is ' + reg.people.length + ', expected 1380');   // D391: 1326 -> 1380 — Spotsylvania adds 18 unique side-unit ids x 3 slots; Elkhorn's own 45-row/15-unit teeth remain stable.
