...
// wall incl. the naval/command-collapse temptations, and the current 1434 Army Register pin.
...
const SETUP = `(() => {
  ...
  try {
    ...
    check('ARMY REGISTER PIN: 27 Fort Donelson units produce exact cmd/nco/pvt trios and current total 1434', function() {
