...
const SETUP = `(() => {
  ...
  try {
    ...
    step('UI D150: Army Register is searchable, filterable, detailed, provenance-marked, and journey-start locked', function(){
      ...
      if(!count || count.textContent.indexOf('1512 of 1512')<0) throw new Error('full registry count missing: '+(count&&count.textContent));   // D397: tracks the 1512-person registry; D393 tracked 1434, D391 tracked 1380 (see the count assertion above).
