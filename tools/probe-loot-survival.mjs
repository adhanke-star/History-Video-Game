...
const SETUP = `(() => {
  ...
  try {
    ...
    step('UI D150: Army Register is searchable, filterable, detailed, provenance-marked, and journey-start locked', function(){
      ...
      var reg=ssPersonRegistry(C);
      if(reg.people.length!==1710) throw new Error('expected current 1710-person registry, got '+reg.people.length);   // D362: 912 -> 957 — Gaines' Mill adds 15 unique units x 3 slots (fragment dropped by a later pin bump; restored in D381 — the pin-bump idiom requires the full documented chain). D364: 957 -> 990 — New Market Heights adds 11 unique units x 3 slots. D366: 990 -> 1068 — Stones River adds 26 unique units x 3 slots. D376: 1068 -> 1125 — Cedar Creek adds 19 unique units x 3 slots. D378: 1125 -> 1170 — Cross Keys / Port Republic adds 15 unique units x 3 slots. D380: 1170 -> 1200 — Five Forks adds 10 unique side-unit ids x 3 slots. D384: 1200 -> 1281 — Fort Donelson adds 27 unique side-unit ids x 3 slots. D388: 1281 -> 1326 — Elkhorn Tavern adds 15 unique side-unit ids x 3 Soldier's Story slots. D391: 1326 -> 1380 — Spotsylvania adds 18 unique side-unit ids x 3 Soldier's Story slots. D393: 1380 -> 1434 — Wilderness adds 18 unique side-unit ids x 3 Soldier's Story slots. D397: 1434 -> 1512 — Petersburg initial assaults adds 26 unique side-unit ids x 3 Soldier's Story slots. D436: 1512 -> 1566 — Atlanta adds 18 unique side-unit ids x 3 slots. D442: 1566 -> 1614 — Cold Harbor adds 16 unique side-unit ids x 3 slots. D460: 1614 -> 1617 — Elkhorn Cherokee OOB (D455 SS3 row 7): Watie's 2nd CMR adds 1 unique side-unit id x 3 slots. D463: 1617 -> 1632 — Fort Pillow adds 5 unique side-unit ids x 3 slots (LANE-013 P4, the D455 SS3 row 6 unlock). D469: 1632 -> 1671 — The Crater adds 13 unique side-unit ids x 3 slots (LANE-015, the D464 spec). D470: 1671 -> 1710 — Olustee adds 13 unique side-unit ids x 3 slots (LANE-016, the D465 spec).
      ...
      if(!count || count.textContent.indexOf('1710 of 1710')<0) throw new Error('full registry count missing: '+(count&&count.textContent));   // D470: tracks the 1710-person registry (Olustee +13x3, LANE-016); D469 tracked 1671 (The Crater +13x3, LANE-015); D463 tracked 1632 (Fort Pillow +5x3, LANE-013 P4, D455 SS3 row 6); D460 tracked 1617 (Elkhorn Cherokee +1x3, D455 SS3 row 7); D442 tracked 1614 (Cold Harbor +16x3); D436 tracked 1566 (Atlanta +18x3); D397 tracked 1512; D393 tracked 1434, D391 tracked 1380 (see the count assertion above).
