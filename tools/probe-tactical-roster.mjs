...
const SETUP = `(() => {
  var R = { ok:true, steps:[] };
  var EXPECTED = ['bullrun1', 'crossKeysPortRepublic', 'gainesMill', 'malvernHill', 'antietam', 'fredericksburg', 'chancellorsville', 'gettysburg', 'newMarketHeights', 'fortDonelson', 'elkhornTavern', 'shiloh', 'stonesRiver', 'vicksburg', 'chickamauga', 'chattanooga', 'olustee', 'fortPillow', 'wilderness', 'spotsylvania', 'coldHarbor', 'petersburgAssaults', 'kennesaw', 'atlanta', 'crater', 'cedarCreek', 'franklin', 'nashville', 'fiveForks'];   // D397: 23 -> 24 — Petersburg initial assaults registers at rank 69 between spotsylvania and kennesaw (single-phase; PHASE_COUNTS unchanged). D442: 25 -> 26 — coldHarbor at the documented 68.5 (single-phase; PHASE_COUNTS unchanged). D463: 26 -> 27 — fortPillow at rank 66 between chattanooga (65) and wilderness (67). D469: 27 -> 28 — crater at rank 71.5 between atlanta (71) and cedarCreek (72) (LANE-015). D470: 28 -> 29 — olustee at rank 65.5 between chattanooga (65) and fortPillow (66) (LANE-016) (LANE-013 P4, the D455 SS3 row 6 unlock; single-phase; PHASE_COUNTS unchanged).
  ...
  try {
    ...
    step('MENU DOM: all registered battle buttons inject once, in roster order, before Skirmish/Command buttons', function() {
      ...
      var ids = ['fldBullRunBtn', 'fldScnBtn_crossKeysPortRepublic', 'fldScnBtn_gainesMill', 'fldScnBtn_malvernHill', 'fldScnBtn_antietam', 'fldScnBtn_fredericksburg', 'fldScnBtn_chancellorsville', 'fldScnBtn_gettysburg', 'fldScnBtn_newMarketHeights', 'fldScnBtn_fortDonelson', 'fldScnBtn_elkhornTavern', 'fldScnBtn_shiloh', 'fldScnBtn_stonesRiver', 'fldScnBtn_vicksburg', 'fldScnBtn_chickamauga', 'fldScnBtn_chattanooga', 'fldScnBtn_olustee', 'fldScnBtn_fortPillow', 'fldScnBtn_wilderness', 'fldScnBtn_spotsylvania', 'fldScnBtn_coldHarbor', 'fldScnBtn_petersburgAssaults', 'fldScnBtn_kennesaw', 'fldScnBtn_atlanta', 'fldScnBtn_crater', 'fldScnBtn_cedarCreek', 'fldScnBtn_franklin', 'fldScnBtn_nashville', 'fldScnBtn_fiveForks'];   // D397: 23 -> 24 buttons — fldScnBtn_petersburgAssaults inserts between spotsylvania and kennesaw. D442: 25 -> 26 buttons — fldScnBtn_coldHarbor inserts between spotsylvania and petersburgAssaults. D463: 26 -> 27 buttons — fldScnBtn_fortPillow inserts between chattanooga and wilderness.
      var found = [];
