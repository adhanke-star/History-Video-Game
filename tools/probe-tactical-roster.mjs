...
const SETUP = `(() => {
  var R = { ok:true, steps:[] };
  var EXPECTED = ['bullrun1', 'crossKeysPortRepublic', 'gainesMill', 'malvernHill', 'antietam', 'fredericksburg', 'chancellorsville', 'gettysburg', 'newMarketHeights', 'fortDonelson', 'shiloh', 'stonesRiver', 'vicksburg', 'chickamauga', 'chattanooga', 'kennesaw', 'cedarCreek', 'franklin', 'nashville', 'fiveForks'];
  var PHASE_COUNTS = { vicksburg: 3, chickamauga: 3, chattanooga: 3, fortDonelson: 3, nashville: 2, newMarketHeights: 2, stonesRiver: 2, cedarCreek: 2, crossKeysPortRepublic: 2 };
  ...
  try {
    ...
    step('MENU DOM: all registered battle buttons inject once, in roster order, before Skirmish/Command buttons', function() {
      ...
      var ids = ['fldBullRunBtn', 'fldScnBtn_crossKeysPortRepublic', 'fldScnBtn_gainesMill', 'fldScnBtn_malvernHill', 'fldScnBtn_antietam', 'fldScnBtn_fredericksburg', 'fldScnBtn_chancellorsville', 'fldScnBtn_gettysburg', 'fldScnBtn_newMarketHeights', 'fldScnBtn_fortDonelson', 'fldScnBtn_shiloh', 'fldScnBtn_stonesRiver', 'fldScnBtn_vicksburg', 'fldScnBtn_chickamauga', 'fldScnBtn_chattanooga', 'fldScnBtn_kennesaw', 'fldScnBtn_cedarCreek', 'fldScnBtn_franklin', 'fldScnBtn_nashville', 'fldScnBtn_fiveForks'];
      var found = [];
