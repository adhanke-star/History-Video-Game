...
const SETUP = `(() => {
  var R = { ok:true, steps:[] };
  var EXPECTED = ['bullrun1', 'crossKeysPortRepublic', 'gainesMill', 'malvernHill', 'antietam', 'fredericksburg', 'chancellorsville', 'gettysburg', 'newMarketHeights', 'shiloh', 'stonesRiver', 'vicksburg', 'chickamauga', 'chattanooga', 'kennesaw', 'cedarCreek', 'franklin', 'nashville', 'fiveForks'];
