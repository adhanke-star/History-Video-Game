...
const SETUP = `(() => {
  var R = { ok:true, steps:[] };
  var EXPECTED = ['bullrun1', 'crossKeysPortRepublic', 'gainesMill', 'malvernHill', 'antietam', 'fredericksburg', 'chancellorsville', 'gettysburg', 'newMarketHeights', 'fortDonelson', 'elkhornTavern', 'shiloh', 'stonesRiver', 'vicksburg', 'chickamauga', 'chattanooga', 'fortPillow', 'wilderness', 'spotsylvania', 'coldHarbor', 'petersburgAssaults', 'kennesaw', 'atlanta', 'crater', 'cedarCreek', 'franklin', 'nashville', 'fiveForks'];   // D397: 23 -> 24 — Petersburg initial assaults registers at rank 69 between spotsylvania and kennesaw (single-phase; PHASE_COUNTS unchanged). D442: 25 -> 26 — coldHarbor at the documented 68.5 (single-phase; PHASE_COUNTS unchanged). D463: 26 -> 27 — fortPillow at rank 66 between chattanooga (65) and wilderness (67). D469: 27 -> 28 — crater at rank 71.5 between atlanta (71) and cedarCreek (72) (LANE-015) (LANE-013 P4, the D455 SS3 row 6 unlock; single-phase; PHASE_COUNTS unchanged).
