...
(async () => {
  ...
  try {
    ...
    const baselineOk =
      ...
      evidence.dataCount === 65 &&   // D436: 55 -> 56 — atlanta.json. D442: 56 -> 57 — cold-harbor.json. D445: 57 -> 58 — chief-of-staff.json (GEA-08). D446: 58 -> 59 — concept-links.json (GEA-10). D463: 59 -> 60 — fort-pillow.json; D469: 60 -> 61 — crater.json (LANE-015); D470: 61 -> 62 — olustee.json (LANE-016); D491: 62 -> 63 — politics.json (LANE-018 Slice 3); D504: 63 -> 64 — conquest-territories.json (LANE-019 Slice 1); D506: 64 -> 65 — conquest-transport-evidence.json (read-only, no Mayhem behavior)
