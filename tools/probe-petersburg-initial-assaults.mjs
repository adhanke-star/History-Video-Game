...
const SETUP = `(() => {
  ...
  try{
    ...
    check('ARMY REGISTER PIN: canonical registry identity plus 26 Petersburg unit trios produce current total 1566',function(){
      ...
      if(reg.people.length!==1566)throw new Error('Army Register total '+reg.people.length+' expected 1566');   // D397: 1434 -> 1512 — Petersburg initial assaults adds 26 unique side-unit ids x 3 slots. D393: 1380 -> 1434 — Wilderness adds 18 unique side-unit ids x 3 slots. D436: 1512 -> 1566 — Atlanta adds 18 unique side-unit ids x 3 slots.
