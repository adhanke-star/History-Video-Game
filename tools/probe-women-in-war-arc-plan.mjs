...
step("BASELINES: the current D400 whole-registry boundary the arc must not move still holds", () => {
  ...
  if (suite.length !== 137) throw new Error("vet suite must stay 137, counted " + suite.length);   // D391: 126 -> 127 — probe-spotsylvania enrolled. D393: 127 -> 128 — probe-wilderness enrolls with the twenty-third battle. D397: 128 -> 129 — probe-petersburg-initial-assaults enrolls with the twenty-fourth battle. D400: 129 -> 130 — probe-war-career enrolls with Slice A. AD-7 re-pin (D443): 130 -> 131 — probe-mayhem-mode enrolls (D418); 131 -> 132 — probe-atlanta (D436); 132 -> 133 — probe-cold-harbor (D442), each appended at the END. D444: 133 -> 134 — probe-learn-battle (GEA-07). D445: 134 -> 135 — probe-chief-of-staff (GEA-08). D446: 135 -> 136 — probe-concept-links (GEA-10), each at the END.
