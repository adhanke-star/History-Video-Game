...
const SETUP = `(() => {
  ...
  try {
    ...
    check('ARMY REGISTER PIN: 11 New Market Heights units produce exact cmd/nco/pvt trios and total 990', function() {
      ...
      if (reg.people.length !== 990) throw new Error('Army Register total is ' + reg.people.length + ', expected 990');
