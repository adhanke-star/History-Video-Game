...
const SETUP = `(() => {
  ...
  try {
    ...
    check('ARMY REGISTER PIN: 11 New Market Heights units produce exact cmd/nco/pvt trios and current total 1566', function() {
