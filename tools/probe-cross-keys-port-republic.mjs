...
const SETUP = `(() => {
  ...
  try {
    ...
    check('ARMY REGISTER PIN: 15 unique Cross Keys / Port Republic side-unit ids produce 45 cmd/nco/pvt rows and current total 1566', function() {
