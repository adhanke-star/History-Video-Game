...
const SETUP = `(() => {
  ...
  try {
    ...
    check('ARMY REGISTER PIN: 15 unique Cross Keys / Port Republic side-unit ids produce 45 cmd/nco/pvt rows and current total 1170', function() {
      ...
      if (reg.people.length !== 1170) throw new Error('Army Register total is ' + reg.people.length + ', expected 1170');
