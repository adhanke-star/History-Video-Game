...
const SETUP = `(() => {
  ...
  try{
    ...
    check('REGISTRY + MENU: Wilderness holds rank 67 between Fort Pillow and Spotsylvania in the 27-scenario registry',function(){
    ...
    check('ARMY REGISTER PIN: canonical registry identity plus 18 Wilderness unit trios produce current total 1632',function(){
