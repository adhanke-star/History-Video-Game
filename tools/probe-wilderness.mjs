...
const SETUP = `(() => {
  ...
  try{
    ...
    check('ARMY REGISTER PIN: canonical registry identity plus 18 Wilderness unit trios produce current total 1617',function(){
