...
function staticPreflight() {
  ...
  check("after-action file frozen", md5(join(ROOT, "src", "82-after-action.js")) === "664db3e3dd84cfc88663bdd0dacec88a", md5(join(ROOT, "src", "82-after-action.js")));   // D443 (AD-6 re-pin): e2a4739946b20b1a725a08d55b4825f6 -> cecf9d405c0b335bea3f5ce81347c139 — D434 (GEA-02) legitimately added the authorized Copy/Download export bar to src/82; the war-career surface itself did not move it. D453 (AD-0 battery re-pin): cecf9d405c0b335bea3f5ce81347c139 -> 590f8a784609305aa253c08a0fb83d95 — D451 (GEA-14) legitimately added the guarded spPacketButtonHtml seam to the src/82 export bar (VETTING DEFERRED, so this pin's sweep was owed to the final audit); the war-career surface itself did not move it. D466 (P6 battery re-pin): 590f8a784609305aa253c08a0fb83d95 -> 664db3e3dd84cfc88663bdd0dacec88a — D457 (`c4bc504`, LANE-012 Slice 2) legitimately added the typeof-guarded mhJudgedNoQuarterPanel seam to src/82 aarRenderReport (probe-afteraction owned and passed that slice's gates; this frozen pin's sweep was owed to the battery — the D443/D453 precedent, third instance); the war-career surface itself did not move it
...
async function main() {
  ...
  try {
    ...
    result = Object.assign(result, runtime, {
      schema: "cw_probe_war_career_v1",
      generatedAt: new Date().toISOString(),
      suite: { expected: 142, actual: list.length, index: 38 },   // D484: display field aligned to the 140 teeth (see header note). // D425: 130 -> 131 (D418 Mayhem row). D443: 131 -> 133 (D436 atlanta + D442 cold harbor rows at the END). D444: 133 -> 134 (learn-battle). D445: 134 -> 135 (chief-of-staff). D446: 135 -> 136 (concept-links) D447: 136 -> 137 (memory-chain). D463: 137 -> 138 (fort-pillow, LANE-013 P4, at the END; row 38 holds). D469/D470: 138 -> 140 — the crater and olustee rows appended at the END (LANE-015/LANE-016); the D469/D470 sweeps moved this probe's 1671/1710 register pins and missed this count tooth (recorded honestly, the D443 AD-6 precedent).
      static: staticResult,
      pageerrors,
      realErrors,
