...
const SETUP = `(() => {
  ...
  try {
    ...
    check('ARMY REGISTER PIN: canonical registry identity plus ten Five Forks unit trios produce current total 1632',function(){
