...
// D518 re-pin: ARC 9 Slice 4 moves srcTree 6a385aa2 -> 6950a862 for strict session-bookmark metadata pointers over existing named slots only; War Career runtime/journey/command/focused/data/manifest/suite hold.
srcTree:"6950a8623e8346984652f4f23178285b",
...
step("BASELINES + LANE", () => {
  ...
  const expectedHashes = {
    ...
    // D518 re-pin: game de2770b2 -> 2249daa3 for strict session-bookmark metadata pointers over existing named slots only; protected War Career owners hold.
...
// D518 re-pin: game de2770b2 -> 2249daa3 and srcTree 6a385aa2 -> 6950a862 for strict session-bookmark metadata pointers over existing named slots only; War Career runtime/journey/focused remain exact.
srcTree:"6950a8623e8346984652f4f23178285b",
    runtime:"dfee8d9c3a6b8c8caa414366302214a7",
    // D478 re-pin: journey 25c1226e -> a527600d (LANE-017 slice 1 adds the cwTierInfo/cwRungTierInfo
    // one-rarity-language helpers + the glyph-redundant card chip to src/37 — presentation-only;
