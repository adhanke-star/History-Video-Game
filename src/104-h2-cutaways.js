...
(function h2CutawayModule() {
  ...
  function h2Css() {
    ...
    s.textContent = [
      ...
      ".h2-cutaway-overlay{position:fixed;inset:0;z-index:99999;background:rgba(3,5,6,.82);display:flex;align-items:center;justify-content:center;padding:18px;color:#f3efe2;font-family:system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;}",
      ".h2-cutaway-card{width:min(980px,96vw);max-height:94vh;overflow:auto;background:linear-gradient(135deg,#071013,#15201c 48%,#090d10);border:1px solid rgba(216,180,88,.44);border-radius:8px;box-shadow:0 28px 90px rgba(0,0,0,.72),inset 0 0 0 1px rgba(255,255,255,.05);position:relative;}",
      ...
      ".h2-cutaway-kicker{margin:0 0 4px;color:#d8b458;font-size:11px;font-weight:950;text-transform:uppercase;}.h2-cutaway-head h1{margin:0;color:#fff7d8;font-size:32px;line-height:1;font-weight:950;letter-spacing:0;}.h2-cutaway-sub{margin:6px 0 0;color:#cbd5c9;font-size:13px;line-height:1.4;}",
      ".h2-cutaway-close{min-height:38px;border-radius:8px!important;}.h2-cutaway-body{display:grid;grid-template-columns:minmax(300px,1.15fr) minmax(240px,.85fr);gap:12px;padding:12px;}",
      ...
      ".h2-cutaway-frame .scene-img{margin:0!important;padding:0!important;background:#050607!important;border:0!important;border-radius:0!important;box-shadow:none!important;}.h2-cutaway-frame .scene-img img{width:100%!important;height:390px!important;max-height:none!important;object-fit:cover!important;display:block!important;border:0!important;filter:grayscale(.08) contrast(1.2) brightness(.76)!important;}.h2-cutaway-frame .scene-img figcaption{margin:0!important;padding:9px 11px!important;background:rgba(0,0,0,.86)!important;color:#f1dfba!important;text-align:left!important;font-style:normal!important;font-size:11px!important;line-height:1.38!important;}",
      ".h2-cutaway-proc{height:390px;position:relative;overflow:hidden;background:radial-gradient(circle at 22% 26%,rgba(216,180,88,.22),transparent 18%),radial-gradient(circle at 74% 58%,rgba(93,134,183,.22),transparent 21%),linear-gradient(135deg,#152018,#253b2f 52%,#10181b);}",
      ...
      "@media (max-width:840px){.h0-brief-actions.h2-cutaway-ready{grid-template-columns:repeat(2,minmax(0,1fr));}.h2-cutaway-body{grid-template-columns:1fr;}.h2-cutaway-frame .scene-img img,.h2-cutaway-proc{height:300px!important;}}@media (max-width:540px){.h0-brief-actions.h2-cutaway-ready{grid-template-columns:1fr;}.h2-cutaway-head,.h2-cutaway-foot{display:block;}.h2-cutaway-close,.h2-cutaway-foot button{width:100%;margin-top:8px;}.h2-cutaway-head h1{font-size:26px;}.h2-cutaway-frame .scene-img img,.h2-cutaway-proc{height:220px!important;}}",
  ...
  function h2CutawayHTML(C) {
    ...
    return '<div class="h2-cutaway-overlay" role="dialog" aria-modal="true" aria-label="Skippable field cutaway">'
      + '<section class="h2-cutaway-card">'
      + '<header class="h2-cutaway-head"><div><p class="h2-cutaway-kicker">Skippable Field Cutaway</p><h1>' + h2Esc(title) + '</h1>'
      + '<p class="h2-cutaway-sub">' + h2Esc(beat) + ' &middot; ' + h2Esc(bd.name || "campaign field") + '</p></div>'
  ...
  function h2OpenCutaway(C) {
    ...
    document.addEventListener("keydown", function h2Key(ev) {
