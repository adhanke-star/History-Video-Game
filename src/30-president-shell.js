...
function _wdRefresh() {
  ...
  if (_wdTab === "muster") {
  ...
  } else if (_wdTab === "warvshistory") {
    html = (typeof divRenderTab === "function") ? divRenderTab(C) : "";
    wire = (typeof divWireTab === "function") ? divWireTab : null;
  } else if (_wdTab === "afteraction") {
    html = (typeof aarRenderTab === "function") ? aarRenderTab(C) : "";
    wire = null;
    ...
    html = (typeof campRenderTab === "function") ? campRenderTab(C) : "";
    wire = (typeof campWireTab === "function") ? campWireTab : null;
  ...
  var tabs = ["economy", "treasury", "diplomacy", "victory", "warvshistory", "afteraction", "armory", "warroom", "clock", "muster", "cabinet", "command", "camp", "decisions", "press", "map"];
...
function openWarDept() {
  ...
  ["economy", "treasury", "diplomacy", "victory", "warvshistory", "afteraction", "armory", "warroom", "clock", "muster", "cabinet", "command", "camp", "decisions", "press", "map"].forEach(function (k) {
