...
var _FLD_BATTLE_META = {
  ...
  olustee:          { theater: "E", badges: false, csFlag: "first-national" },   // 20 Feb 1864 (D470, the D465 spec §8: no AotP corps badges — the Department of the South column predates X Corps badge issue here, badges false; the first national is the fortDonelson/elkhorn Inferred-representative precedent for Finegan's February-1864 Florida troops, not a claim every regiment carried one flag.)
  fortPillow:       { theater: "W", badges: false, csFlag: "anv" },            // 12 Apr 1864 (D463: Forrest's cavalry corps in West Tennessee — no AotP corps badges. The Southern Cross is an Inferred representative family for Forrest's 1864 command, not a claim that every regiment carried one identical flag; his corps was not the Hardee-pattern Army of Tennessee infantry lineage.)
  wilderness:       { theater: "E", badges: true,  csFlag: "anv" },            // 5-7 May 1864 (D393: AotP II/V/VI Corps badges legible; Hill's and Longstreet's ANV attackers use the Southern Cross family. Representative family, not a claim that every regiment carried one identical flag.)
  spotsylvania:     { theater: "E", badges: true,  csFlag: "anv" },            // 12 May 1864 (D391: AotP II/VI Corps badges legible — the Five Forks precedent; Ewell's ANV Second Corps defenders use the Southern Cross family. An Inferred representative family, not a claim that every regiment carried one identical flag.)
  coldHarbor: { theater: "E", badges: true, csFlag: "anv" },                   // 3 Jun 1864 (D442: AotP II/VI Corps badges legible; the XVIII Corps is Army of the James — the badge institution models the AotP set only, the NMH precedent note. The ANV defenders use the Southern Cross family; an Inferred representative family.)
  petersburgAssaults: { theater: "E", badges: true,  csFlag: "anv" },          // 15-18 Jun 1864 (D397: AotP II/V/IX and XVIII Corps badges legible; the June-1864 Virginia defenders and the arriving First Corps use the Southern Cross family. An Inferred representative family, not a claim that every regiment carried one identical flag.)
  kennesaw:         { theater: "W", badges: false, csFlag: "hardee" },         // 27 Jun 1864 (Army of Tennessee)
  atlanta:          { theater: "W", badges: false, csFlag: "hardee" },         // 22 Jul 1864 (Army of Tennessee under Hood — the same Western Hardee-pattern family carried from Stones River through Nashville; D436)
  crater:           { theater: "E", badges: true, csFlag: "anv" },             // 30 Jul 1864 (D469, the D464 spec §8: AotP IX Corps badges legible — the D397 Petersburg precedent; Mahone's division is ANV.)
