...
5. **Group 5 — Phase H polish/media/perf (started D193):** media budget guard ✅ D193; remaining: surviving-colours/PD asset polish, H2 real footage only after per-asset PD provenance and anachronism review, render/readability polish, audio polish, Intel UHD-617 profiling, and any heavier embedded-media budget decisions. No unclear-license assets, accounts/trials/download dependencies, runtime web dependencies, or Tripo actions without explicit approval.
