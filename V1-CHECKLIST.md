...
4. **Group 4 — remaining Phase F/G non-battle content systems (NEXT):** hard war ✅ D175, irregular war ✅ D177, under-told perspectives still not covered by the D153 women lane, flagship named units, CS finance toolkit, war-finance civics, real diplomacy, human-cost-with-gravity, and Western-theater strategic readouts that do not create playable battles. Keep War Effort/bridge/save contracts bounded and anti-Lost-Cause.
