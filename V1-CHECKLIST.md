...
### Phase J — POLISH / META
- [~] **Saves** ‹PROPOSED per D54›: localStorage + named slots + export/import; undo-last-turn on the accessible preset. Named slots + export/import already exist in `src/91-save-slots.js`; remaining work is a focused Phase J hardening pass: probe menu reinjection after menu rebuilds, export/import round-trip, save-slot load/delete/rename behavior, migration/invalid-payload handling, keyboard/a11y coverage, and the accessible undo-last-turn preset.
