...
- [~] **C2 Western** ‹LOCKED: Phase C, with breadth›: ~~Shiloh~~ ✅ (first Western theater battle, single-phase Fredericksburg-pattern scenario; probe-shiloh 29/29). ~~Vicksburg~~ ✅ (the river-fortress SIEGE as a 3-phase battle — Stockade Redan → Forlorn Hope → the Saps & the Mine; data/vicksburg.json + registry/menu rank 55; probe-vicksburg 18/18; the May assaults now cost the attacker, the siege wins, the city falls; D86). Remaining: Chickamauga/Chattanooga, Atlanta/the March, Franklin.
