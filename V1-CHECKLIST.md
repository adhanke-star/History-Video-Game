...
- [ ] Mod-friendly data + shareable scenarios. Save-file share/import hardening is complete (D146); broader mod-friendly data/scenario packaging remains open. **Hosting DEFERRED** (GitHub Pages on request — D54).
