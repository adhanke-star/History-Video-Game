...
- [ ] **ARC 9 — desk-to-battle pacing.**
  ...
  - [ ] Collapse repeated click paths, add one-click re-engagement, and remember safe preferences.
...
- [ ] **E51:** decide whether `raidSupply` needs real-time morale parity or corrected copy.
- [ ] **E61:** collapse-terminal behavior beyond the shipped nudge half.
- [ ] **E46:** Piper-farm guns; the honest reattempt stayed red under the unchanged historical gate and remains parked.
