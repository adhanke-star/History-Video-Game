...
- [~] **"The Soldier's Story" (D93, Aaron) — build AFTER the C+E roadmap; unified with the journey mode above.**
      ...
      **detail cards** (DATA, reuses teaching cards, NO engine change — brigades stay one marker per the D68
      ...
      persistence, battle association, status history, promotion count, and after-action report tie-in. **D154-D156 shipped
      the first three narrow citation-grade named-person slices:** Elisha Hunt Rhodes replaces one generated Bull Run private
      ...
      and no unsupported portrait claim. **Still open:** citation-grade named bios/portraits/unit detail
      at scale for every identifiable person, richer start-anywhere career trajectory, and later interpersonal hooks.
      (Memory `civilwar-soldiers-story-pillar`; DECISIONS D93/D148/D150/D151/D154/D155/D156.)
