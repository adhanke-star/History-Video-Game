...
**Status:** D421 content (forty-two `Verified` records). This citation-grade lane replaces generated Soldier's Story representatives with sourced named people. D421 adds Christian A. Fleetwood, Powhatan Beaty, and James Gardiner at New Market Heights; side balance is **18US/24CS**. Live runtime has 1,437 open generated `ss:` rows after the batch. LANE-002 is CONTRACT/unowned; further batches require a fresh bounded DRIVE lock and the same rank-at-battle, unit, source, and women-in-war separation law.
