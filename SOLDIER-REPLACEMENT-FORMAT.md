...
**Status:** D297 (thirty `Verified` records). This is the import lane for replacing generated Soldier's Story representative rows with sourced named people. D152 shipped the empty tooling lane; D154-D158 added the first five narrow sourced replacement slices, D172 added Strong Vincent as the sixth, D214 added Leander Stillwell as the seventh, D215 added John Cook as the eighth, D216 added Orion P. Howe as the ninth, D217 added Francis A. Waller as the tenth, D218 added Samuel N. Benjamin as the eleventh, D219 added Francis C. Barlow as the twelfth, D220 added John H. Worsham as the thirteenth, D221 added Sullivan Ballou as the fourteenth, D222 added Alexander S. Webb as the fifteenth, D239 added John O. Casler as the sixteenth (the first Chancellorsville record), and D289 added three at once — Henry M. Stanley (seventeenth; the first Western-CS record), John Dooley (eighteenth; the first Confederate Gettysburg record), and Joseph H. De Castro (nineteenth; a 19th Massachusetts / Hall's Brigade corporal at the Angle). **D290 added three more at once, a CS-weighted theater-balancing slice** — Berry Benson (twentieth), John W. "Johnny" Green (twenty-first; 9th Kentucky "Orphan Brigade" NCO slot at Chickamauga), and William H. Tunnard (twenty-second; the first Vicksburg Confederate record). **D291 added three more, again all Confederate and all Western** — Val C. Giles (twenty-third), William Pitt Chambers (twenty-fourth; the second Vicksburg-CS record), and Sam Houston Jr. (twenty-fifth). **D293 added John S. Jackman as the twenty-sixth**, a Private of Company B, 9th Kentucky Infantry, Helm's Kentucky "Orphan Brigade," in Breckinridge's Division at Chickamauga, replacing `ss:chickamauga:CS:cs_breck_rock:pvt` beside D290's John W. Green NCO row. **D294 added John Camden West as the twenty-seventh**, a Private of Company E, 4th Texas Infantry, Robertson's Texas Brigade, Hood's Division (Law commanding) at Chickamauga, replacing `ss:chickamauga:CS:cs_law_gap:pvt` beside D291's Val C. Giles NCO row. **D295 added Taliaferro N. "Tally" Simpson as the twenty-eighth**, a Corporal of Companies A/B, 3rd South Carolina Infantry, Kershaw's Brigade, McLaws' Division, Longstreet's Corps at Chickamauga, replacing `ss:chickamauga:CS:cs_kershaw_rock:nco`; his bio keeps enslaved Zion visible so the Confederate enlisted letters are not romanticized. **D296 added John W. Haley as the twenty-ninth**, a Private of Company I, 17th Maine Infantry, de Trobriand's Brigade, Birney's First Division, III Corps / Army of the Potomac at Gettysburg, replacing `ss:gettysburg:US:us_birney_iii:pvt`; no Gettysburg-corporal claim or portrait is asserted. **D297 added Bushrod R. Johnson as the thirtieth**, a Brig. Gen. commanding Johnson's Provisional Division in Longstreet's Left Wing / Hood's Corps at Chickamauga, replacing `ss:chickamauga:CS:cs_johnson_gap:cmd`; no major-general-at-Chickamauga, company-command, portrait, or sourced-ratings claim is asserted. Side balance is now **15US/15CS**. Continue only where source trail and slot fit are exact.
