# LEGACY — REVIEW-QUEUE historical content (runs e/f/g/h, 2026-06-13/14)

**Moved out of `REVIEW-QUEUE.md` in D236 (FABLE AUDIT M11, ledger items S16/S35).** This is the pre-pivot run-e/f/g/h priorities/locks material that used to live beneath the audit ledger — long superseded (the UG:G pivot shipped through D142; current priorities live in `V1-CHECKLIST.md` + `START-HERE.md`). Reference only; do NOT follow as live strategy.
